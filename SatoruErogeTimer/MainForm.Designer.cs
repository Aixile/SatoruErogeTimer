namespace SatoruErogeTimer
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.GetProcessToolStripMenuItem.Size = new System.Drawing.Size(44, 22);
			this.GetProcessToolStripMenuItem.Text = "追加";
			this.GetProcessToolStripMenuItem.Click += new System.EventHandler(this.GetProcessStripMenuItem_Click);
			// 
			// 同期ToolStripMenuItem
			// 
			...
			this.EditNameToolStripMenuItem.Text = "名前を編集する";
			...
			this.EditTimeToolStripMenuItem.Text = "時間を編集する";
			...
			this.パース設定ToolStripMenuItem.Text = "パスを編集する";
			this.パース設定ToolStripMenuItem.Click += new System.EventHandler(this.パス設定ToolStripMenuItem_Click);
			// 
			...
			this.DeleteGameToolStripMenuItem.Click += new System.EventHandler(this.DeleteToolStripMenuItem_Click);
			// 
			// lstShow
			// 
