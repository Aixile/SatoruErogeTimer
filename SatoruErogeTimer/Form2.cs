...
namespace SatoruErogeTimer
{
    public partial class Form2 : Form
    {
        ...
        private void 確認ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("パース必要！", "ErogeTimer");
            }
            else
            {
                    erogeCart.processName = lstShow.SelectedItems[0].SubItems[1].Text;
                    erogeCart.addr = lstShow.SelectedItems[0].SubItems[3].Text;
                    erogeCart.title = lstShow.SelectedItems[0].SubItems[4].Text;
